...
def Category(request, id):
    return HttpResponse(f"Bu {id}-raqamli kategoriya sahifasi")
...
class CatalogView(TemplateView):
    ...
    FILTER_MAPPING = {
        ...
        'size' : lambda queryset, value: queryset.filter(product_size_size__name=value),
    }
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):  
            ...
            elif request.GET.get('reset_search'):
                return TemplateResponse(request, 'main/psearch_button.html',{}  )
...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['ccurrent_categories'] = product.category.slug
        return context
